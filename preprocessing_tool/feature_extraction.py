...
def get_window_stats_27_features(ppg_seg,fs, window_length, ensemble, ma_usage):  
    ...
    td_features, hr = calc_td_hrv(RR_list, RR_diff, RR_sqdiff, window_length)
